...
export const AuditBookingModal: React.FC<ModalProps> = ({ isOpen, onClose, preselectedIndustry }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={resetAndClose}>
      <DialogContent className="bg-white border border-slate-200 text-slate-900 max-w-xl p-6 sm:p-8 rounded-3xl shadow-2xl">
        ...
        {submitted ? (
          <div className="py-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-[#0B1B3D]">Your Audit Call Is Queued!</h3>
              <p className="text-slate-600 text-sm max-w-md mx-auto leading-relaxed">
                Thank you, <strong className="text-amber-700">{ownerName || "Business Owner"}</strong>. Andy is personally reviewing <strong className="text-[#0B1B3D]">{businessName || "your business"}</strong> and will reach out shortly.
              </p>
            </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 bg-slate-50 border-slate-200 text-slate-900 rounded-xl py-5 text-xs sm:text-sm"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    className="bg-slate-50 border-slate-200 text-slate-900 rounded-xl text-xs sm:text-sm h-20"
                  />
                </div>
                ...
                <div className="flex gap-3 pt-2">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => setStep(1)}
                    className="border-slate-200 text-slate-700 bg-white hover:bg-slate-50 rounded-xl px-5"
                  >
                    Back
                  </Button>
