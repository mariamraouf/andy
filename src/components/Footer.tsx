...
import { TreePalm as PalmTree, ShieldCheck } from "lucide-react";

export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0B1B3D] text-white border-t border-slate-800 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-12 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-500 text-[#0B1B3D] flex items-center justify-center shadow-md">
                <PalmTree className="w-6 h-6 stroke-[2.2]" />
              </div>
              <span className="text-2xl font-black font-serif tracking-wider text-white uppercase">
                CRUZIAN
              </span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 text-xs text-amber-400 bg-amber-500/10 px-3 py-1.5 rounded-full border border-amber-500/30 font-mono">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-300 font-medium">
              <li><Link to="/" className="hover:text-amber-400 transition-colors">Platform Engine</Link></li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          ...
          <div className="flex items-center gap-6 font-mono text-[11px]">
            <span className="text-amber-400 font-bold">ST. CROIX • US VIRGIN ISLANDS</span>
          </div>
        </div>
